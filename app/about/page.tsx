    ...
    <>
      <div className="bg-black min-h-screen">
        <div className="container mx-auto px-6 py-12 max-w-5xl">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-tight text-[#FE7743] mb-10 text-center">
            About Altiverr
          </h1>
          
          <div className="grid grid-cols-1 md:grid-cols-10 gap-12 items-start mb-20">
            <MotionFadeIn className="space-y-8 md:col-span-4">
              <div className="relative h-[400px] rounded-xl shadow-xl overflow-hidden">
                <Image 
            ...
            <MotionFadeIn className="prose dark:prose-invert max-w-none md:col-span-6">
              <p className="text-lg text-[#EFEEEA]/90 mb-6">
              ...
              <p className="text-lg text-[#EFEEEA]/90 mb-10 font-medium">
