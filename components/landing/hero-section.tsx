      ...
      <div className="flex flex-col items-center justify-center pt-28">
        <h1 className="bg-gradient-to-br dark:from-white from-black from-30% dark:to-white/40 to-black/40 bg-clip-text py-6 text-4xl font-medium leading-none tracking-tighter text-transparent text-balance sm:text-5xl md:text-6xl lg:text-7xl translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
          Achieve Peak Operational Efficiency with Altiverr's <span className="relative whitespace-nowrap">
            <span className="relative z-10 bg-gradient-to-r from-slate-400 via-slate-500 to-slate-600 bg-clip-text text-transparent font-bold">PEAK</span>
        ...
        <p className="mb-6 text-lg tracking-tight text-gray-400 md:text-xl text-balance translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
        ...
        <p className="mb-12 max-w-3xl text-lg tracking-tight text-gray-400 md:text-xl text-balance translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
        ...
        <div className="relative group mb-5">
          <button
            ...
            className={cn(
              ...
              "relative bg-gradient-to-r from-slate-500 via-slate-600 to-slate-700 text-white rounded-full px-8 py-6 text-lg font-medium group-hover:scale-105 transition-all duration-300"
            )}
          >
